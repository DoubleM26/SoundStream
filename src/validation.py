...
class Validation:
    def __init__(self, config):
        ...
        val_dataset = EvalSoundStreamDataset("./", config["data"]["sample_rate"])
        self.dataloader = DataLoader(val_dataset, batch_size=config["validation"]["batch_size"], shuffle=False)
    ...
    def validate(self, model):
        ...
        for batch in self.dataloader:
            ...
            nisqa_data.append(to_scalar(self.nisqa(recon.squeeze(1))[0, 0]))
